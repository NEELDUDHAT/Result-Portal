		...
		<form method="post" action="">
			<table border="0" cellpadding="5" cellspacing="5" class="design">
				...
				<tr>
					...
					<td><input type="text" name="s1" class="fields" size="5" placeholder="20" required="required" />
					</td>
				</tr>
				<tr>
					<td class="labels">
					...
					<td><input type="text" name="s2" class="fields" size="5" placeholder="20" required="required" />
					</td>
				</tr>
				<tr>
					<td class="labels">
					...
					<td><input type="text" name="s3" class="fields" size="5" placeholder="20" required="required" />
					</td>
				</tr>
				<tr>
					<td class="labels">
					...
					<td><input type="text" name="s4" class="fields" size="5" placeholder="20" required="required" />
					</td>
				</tr>
				<tr>
					<td class="labels">
					...
					<td><input type="text" name="s5" class="fields" size="5" placeholder="20" required="required" />
					</td>
				</tr>
				<tr>
